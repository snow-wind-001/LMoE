...
def parser_args():
    ...
    parser.add_argument('--imagebind_ckpt_path', type=str,default='/home/user/git_code/LMOE/code/AnomalyGPT/pretrained_ckpt/imagebind_ckpt/imagebind_huge.pth') # the path that stores the imagebind checkpoint
    ...
    parser.add_argument('--delta_ckpt_path', type=str,default='/home/user/git_code/LMOE/code/AnomalyGPT/pretrained_ckpt/pandagpt_ckpt/7b/pytorch_model.pt') # the delta parameters trained in stage 1
    ...
    parser.add_argument('--data_path', type=str,default='/home/user/git_code/LMOE/code/AnomalyGPT/data/pandagpt4_visual_instruction_data.json') # the maximum sequence length
